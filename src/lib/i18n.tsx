...
const translations: Record<string, Record<string, string>> = {
  ...
  "services.headline": {
    tr: "Yapay Zeka ile İçerik Üretimi — Hizmetlerimizi Keşfedin",
    en: "AI Content Production — Explore Our Services",
  },
  "services.subtitle": {
    tr: "Reklam filmi, görsel üretim, sosyal medya ve daha fazlası — yapay zeka ile markanızı büyütün.",
    en: "Ad films, visual production, social media and more — grow your brand with AI.",
  },
