  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (code === "auth/user-not-found") {
        // Don't leak existence — show generic success anyway for security.
        // (Mirror Firebase's own behavior in newer SDKs.)
        setStatus("success");
              ...
              <div className="p-4 rounded-xl bg-[var(--lime)]/10 border border-[var(--lime)]/30 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-300 leading-relaxed">
                    Şifre sıfırlama linki gönderildi. Spam klasörünü de kontrol
                    etmeyi unutma.
                  </p>
                </div>
              </div>
